...
<template>
   <div class="bg-white rounded-xl  p-4 w-full">
      ...
      <div class="flex items-center justify-between mb-4">
         <button @click="prevMonth" class="p-1 rounded-lg hover:bg-gray-100 transition-colors">
         ...
         <button @click="nextMonth" class="p-1 rounded-lg hover:bg-gray-100 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-600" viewBox="0 0 20 20"
               fill="currentColor">
               <path fill-rule="evenodd"
      ...
      <div class="grid grid-cols-7 gap-1">
         <template v-for="(week, weekIndex) in daysInMonth" :key="weekIndex">
            <div v-for="(day, dayIndex) in week" :key="dayIndex" @click="selectDate(day)" :class="[
